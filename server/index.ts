...
(async () => {
  ...
  // Use a porta fornecida pelo ambiente (por exemplo, Railway) ou 5000 como padrão
  ...
  server.listen({
    ...
    log(`Servidor rodando na porta ${port} no ambiente ${process.env.NODE_ENV || 'development'}`);
  });
})();
